...
const ManageBrandMappings = lazy(() => import('./pages/admin/ManageBrandMappings'))
  ...
  return (
    <Routes>
      ...
      <Route path="/admin" element={<AdminLayout />}>
        ...
        <Route path="brand-mappings" element={<SuspenseWrapper><ManageBrandMappings /></SuspenseWrapper>} />
